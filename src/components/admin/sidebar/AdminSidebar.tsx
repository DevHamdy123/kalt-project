      ...
      >
        <div className="flex flex-col h-full w-full">
          ...
          <div className="flex h-20 items-center gap-2 mt-4 px-8 shrink-0">
            ...
            <h2
              className={`text-2xl font-bold text-[#363949] dark:text-[#edeffd] transition-opacity duration-300 whitespace-nowrap ${
            ...
            {adminLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`font-medium text-[1.1rem] transition-opacity duration-300 whitespace-nowrap ${
                      isOpen
                        ? "opacity-100"
