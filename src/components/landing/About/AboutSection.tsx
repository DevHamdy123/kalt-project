  ...
  return (
    <section className="relative w-full h-dvh bg-bg-inner text-black flex flex-col overflow-hidden px-5 md:px-16 lg:px-24 pt-5 pb-0 lg:pt-24 lg:pb-0">
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-px h-[70%] bg-black hidden lg:block origin-center"
      />
      ...
      <motion.div
        ...
        className="absolute top-4 right-4 lg:top-8 lg:right-8 z-30 flex flex-col items-end gap-1"
      >
