    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 lg:bottom-10 lg:right-10 z-[100] flex items-center justify-center w-10 h-10 lg:w-12 lg:h-12 border border-[#FF5E00]/50 rounded-full bg-[#FF5E00]/10 backdrop-blur-md text-[#FF5E00] hover:bg-[#FF5E00] hover:border-[#FF5E00] hover:text-white transition-all duration-500 group cursor-pointer shadow-[0_4px_20px_rgba(255,94,0,0.15)] hover:shadow-[0_4px_25px_rgba(255,94,0,0.3)]"
        >
